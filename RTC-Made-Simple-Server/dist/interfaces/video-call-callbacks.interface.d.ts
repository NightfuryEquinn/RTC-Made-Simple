...
export interface VideoCallCallbacks {
    onCallCreated?: (callerName: string, receiverName: string, conversationId?: number) => Promise<void>;
     ...
     */
    canConnect?: (callerName: string, roomName: string | undefined, handshake: Record<string, unknown>) => Promise<boolean> | boolean;
}
//# sourceMappingURL=video-call-callbacks.interface.d.ts.map