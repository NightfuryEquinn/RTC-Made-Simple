...
export declare const createChatSocket: (userName: string, roomName: string, baseUrl: string) => Socket<import("@socket.io/component-emitter").DefaultEventsMap, import("@socket.io/component-emitter").DefaultEventsMap>;
